import { BarChart3, ExternalLink, FileText, KeyRound, Layers, LogOut, Route, Settings } from 'lucide-react';
...
const brandImageSrc = new URL('../../../icon.png', import.meta.url).href;
    ...
    <div className="flex h-screen flex-col bg-background">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        >
          ...
          <div className={cn(desktopMode ? 'px-3 pb-3 pt-3' : 'px-2 pb-4 pt-3')}>
            {desktopMode ? (
              <img src={brandImageSrc} alt="wuAPI" className="w-[92%] object-contain object-left" />
            ) : (
